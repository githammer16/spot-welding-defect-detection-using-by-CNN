# -*- coding: utf-8 -*-
"""
Created on Wed Oct  6 21:19:10 2021
...
# -*- coding: utf-8 -*-
"""
Created on Sat Aug 21 19:46:06 2021
...
# checkpoint
#checkfile_path="weights.best.hdf5"
#check_point = ModelCheckpoint(filepath, monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')
...
test_filenames = os.listdir("../VGG16_punta/working/test/")
...
for index, row in sample_test.iterrows():
    ...
    img = load_img("../VGG19_gazalti/working/test/"+filename, target_size=(256, 256))
